...
tags:
  - Astro
description:
  本文描述的是令人啧啧称赞的博客所具备的特性，受到了 Daniel 所列举的他所喜欢的博客微特性的启发，并做了一些尝试。
---
...
当 Daniel 将这篇文章动态发布在 [HN]([https://news.ycombinator.com/item?id=40774277]) 后，吸引了很多人讨论，于是该主题上了 HN 热门。

从我的观察来看，在某种程度上，这些特性会成为实现现代个人网站的“共识”，本文计划先对此话题的讨论进行回顾，然后逐个讨论，其次我会列举我在本博客已实现的部分。

但在开始之前，我想先探讨为什么会有这些创新和如何更好发现这些创新，至于实现这些创新，在我们这个时代，确实变得更容易了。
...
内容创作者，往往也是微特性的主动使用者和创造者，创作者们在博客中呈现自己的观点，并希望博客文章更广泛的传播，以让观点更充分地影响世界。

从用户角度来说，他们可能是被动使用者，他们消费了博客文章，并希望获得更多内容（价值）。

从内容创作者和消费者视角思考，微创新的本质算是一种内容认知效率工具。
...
43. 单击链接时闪烁/突出显示片段，添加一些填充以确保标头没有覆盖片段的一部分：前者本网站已实现，后者看起来像一个 Bug，需要被修复，即锚链需要考虑固定头部的高度，我已在 https://blog.tt4e.com 中实现。
